...
class TodayStateModel extends ChangeNotifier {
  ...
  TodayStateModel(
      ...
      this.updateTypeIcon = false,
      this.selectTypeIndex = 2,
      this.updateLeveleIcon = false,
      ...
      switch (index) {
        case 0:
          this.dateTips =
              ...
              "${DateUtil.getZHWeekDay(DateTime(pageModel.selectDate.year, pageModel.selectDate.month, pageModel.selectDate.day))} ${_formatDateTxt(pageModel.initTimePoint[1])}:${_formatDateTxt(pageModel.initTimePoint[2])}";
        ...
        case 1:
          this.dateTips =
              "${pageModel.selectDate.year}年${pageModel.selectDate.month}月${pageModel.selectDate.day}日 "
              "${DateUtil.getZHWeekDay(DateTime(pageModel.selectDate.year, pageModel.selectDate.month, pageModel.selectDate.day))} ${_formatDateTxt(pageModel.initTimeDistanceStart[1])}:${_formatDateTxt(pageModel.initTimeDistanceStart[2])}~${_formatDateTxt(pageModel.initTimeDistanceEnd[0])}:${_formatDateTxt(pageModel.initTimeDistanceEnd[1])}";
          break;
        case 2:
          this.dateTips =
              "${pageModel.selectDate.year}年${pageModel.selectDate.month}月${pageModel.selectDate.day}日 "
