...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  _ModalBottomSheetLayout(this.progress, this.isScrollControlled, this. ratio);
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
      ...
      minHeight: 0.0,
      maxHeight: constraints.maxHeight*ratio
        ...
        return Semantics(
          ...
          child: ClipRect(
            child: CustomSingleChildLayout(
              delegate: _ModalBottomSheetLayout(animationValue, widget.isScrollControlled,widget.ratio),
              child: BottomSheet(
