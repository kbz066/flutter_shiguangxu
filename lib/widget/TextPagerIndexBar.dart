...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _TextPagerIndexBarState tabBar;
...
class TextPagerIndexBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _TextPagerIndexBarState createState() => _TextPagerIndexBarState();
}

class _TextPagerIndexBarState extends State<TextPagerIndexBar> {
  ...
  @override
  void didUpdateWidget(TextPagerIndexBar oldWidget) {
